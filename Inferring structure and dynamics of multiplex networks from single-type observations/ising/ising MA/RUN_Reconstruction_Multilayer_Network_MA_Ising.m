function [SUC_F1_best,SUC_F1_min,SUC_F1_all]=RUN_Reconstruction_Multilayer_Network_MA_Ising(w_r,E_r,w)
%Ising多层网络重构，跑实验，计算精度
...
SUC_F1_best=[SUC_F1_all(id1,:),w_r{id1,1}];
...
SUC_F1_min=[SUC_F1_all(id2,:),w_r{id2,1}];
